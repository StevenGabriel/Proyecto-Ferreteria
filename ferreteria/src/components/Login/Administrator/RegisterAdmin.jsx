  ...
  return (
    <div className="bg-white px-10 py-20 rounded-3xl border-2 border-gray-100">
      ...
      <div>
        ...
        <div>
          <label className="text-lg font-medium">CI</label>
          <input
            className="w-full border-2 border-gray-100 rounded-xl p-4 mt-1 bg-transparent"
        ...
        <div>
          <label className="text-lg font-medium">Dirección</label>
          <input
            className="w-full border-2 border-gray-100 rounded-xl p-4 mt-1 bg-transparent"
      ...
      <div className="mt-8 flex justify-center items-center">
        <Link to="/loginClie" className="text-cyan-700 text-base font-medium ml-2">
          Volver?
        </Link>
      </div>
    </div>
